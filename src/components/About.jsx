...
const About = () => {
  return (
    ...
    <div className='px-4 Ig:px-14 max-w-screen-2xl mx-auto my-8' id='about'>
        ...
        <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto bg-neutralSilver py-16'>
            <div className='flex flex-col md:flex-row justify-between items-center gap-8'>
                ...
                <p className='md:w-3/4 text-sm text-neutralGrey '>We reached here with our hard work and dedication</p>
                </div>
